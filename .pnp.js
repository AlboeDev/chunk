...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "@chunk/api",
        "reference": "workspace:packages/@chunk/api"
      },
      {
        "name": "@chunk/client",
        "reference": "workspace:packages/@chunk/client"
      }
    ],
    "enableTopLevelFallback": true,
    "ignorePatternData": "(^(?:\\.yarn\\/sdks(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)|$))$)",
    "fallbackExclusionList": [
      ["@chunk/api", ["workspace:packages/@chunk/api"]],
      ["@chunk/client", ["workspace:packages/@chunk/client"]],
      ["chunk", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    ...
    "packageRegistryData": [
      ...
      ["@chunk/api", [
        ["workspace:packages/@chunk/api", {
          "packageLocation": "./packages/@chunk/api/",
          "packageDependencies": [
            ["@chunk/api", "workspace:packages/@chunk/api"]
          ],
          "linkType": "SOFT",
      ...
      ["@chunk/client", [
        ["workspace:packages/@chunk/client", {
          "packageLocation": "./packages/@chunk/client/",
          "packageDependencies": [
            ["@chunk/client", "workspace:packages/@chunk/client"]
          ],
          "linkType": "SOFT",
